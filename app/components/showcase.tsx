...
export function ShowcasePage() {
  ...
  return (
    ...
    >
      {/* 标题区 */}
      <div
        style={{ padding: "40px 40px 20px", borderBottom: "1px solid #f1f5f9" }}
      >
        <h2
          style={{
            fontSize: "30px",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            ...
            <div
              style={{ fontSize: "14px", color: "#0c4a6e", lineHeight: "2" }}
            >
              • 硬件整机一套（含出厂基础配置）
              <br />
              • 完整推理软件栈（SGLang + KTransformers）
              <br />
              • DeepSeek-V3/R1 模型部署、参数校验与调优
              <br />• 交付验收材料：部署/运维/用户手册与基线测试报告
            </div>
          </div>
        </div>
